...
void image_histogram::actualizar_histograma(QVector<QVector<int> > n_histogram){
    int index = n_histogram[3][0];
    qDebug() << index;
    histogramas_[index][0] = n_histogram[0];
    histogramas_[index][1] = n_histogram[1];
    histogramas_[index][2] = n_histogram[2];
}
